import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name } from './Posts.vue.ts';
...
{
const __VLS_15 = __VLS_intrinsicElements["textarea"];
const __VLS_16 = __VLS_elementAsFunctionalComponent(__VLS_15);
const __VLS_17 = __VLS_16({ ...{}, value: ((__VLS_ctx.body)), }, ...__VLS_functionalComponentArgsRest(__VLS_16));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_15, typeof __VLS_17> & Record<string, unknown>) => void)({ ...{}, value: ((__VLS_ctx.body)), });
...
__VLS_30 = { click: (__VLS_ctx.createPost) };
(__VLS_28.slots!).default;
}
(__VLS_3.slots!).default;
}
{
const __VLS_31 = __VLS_intrinsicElements["h1"];
...
{
const __VLS_46 = __VLS_intrinsicElements["h3"];
...
// @ts-ignore
[title, body, body, createPost, posts,];
}
